...
//引入图片
import Header from '@/projects/admin/assets/Out_header/header.vue';
import img_bg from '@/projects/admin/assets/login/login_bg.jpg';
import account_ico_active from '@/projects/admin/assets/login/login_account_ico_active.png';
import account_ico from '@/projects/admin/assets/login/login_account_ico.png';
import phone_ico_active from '@/projects/admin/assets/login/login_phone_ico_active.png';
import phone_ico from '@/projects/admin/assets/login/login_phone_ico.png';
import advertising_img from '@/projects/admin/assets/login/advertising1.jpg';
import ligon_footer_bg from '@/projects/admin/assets/login/ligon_footer_bg.png';
                ...
                if (valid) {
                    ...
                    _this.$store.dispatch('Login', this.loginForm).then((authRes) => {
                        if(authRes.status==10000){
                            _this.saveUserInfo();
                            _this.$router.push({ path: '/account/list' })  
                        }                
                    }).catch((error) => {
...
@import '@/projects/admin/styles/index.scss';
