...
import store from '@/projects/admin/store'

import logout_img from '@/projects/admin/assets/common/logout_ico.png'
import userCenter_img from '@/projects/admin/assets/common/usercenter_ico.png'
import msg_img from '@/projects/admin/assets/common/msg_ico.png'
import help_img from '@/projects/admin/assets/common/help_ico.png'

import logout_img_hover from '@/projects/admin/assets/common/logout_ico_hover.png'
import userCenter_img_hover from '@/projects/admin/assets/common/usercenter_ico_hover.png'
import msg_img_hover from '@/projects/admin/assets/common/msg_ico_hover.png'
import help_img_hover from '@/projects/admin/assets/common/help_ico_hover.png'

import img_logo from "@/projects/admin/assets/login/logo.png"
