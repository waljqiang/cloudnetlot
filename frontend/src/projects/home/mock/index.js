...
Mock.mock(/\/backend\/device\/reports/, 'post', devAPI.refresh)
Mock.mock(/\/backend\/device\/setname/, 'post', devAPI.setName)
Mock.mock(/\/backend\/device\/restart/, 'post', devAPI.reboot)
Mock.mock(/\/backend\/device\/timerestart/, 'post', devAPI.timerestart)
Mock.mock(/\/backend\/device\/deletes/, 'post', devAPI.deletes)
Mock.mock(/\/backend\/device\/getwifioptions/, 'post', devAPI.wifiOptions)
Mock.mock(/\/backend\/device\/wifi\/info/, 'post', devAPI.wifiInfos)
Mock.mock(/\/backend\/device\/setwifi/, 'post', devAPI.setWifi)
Mock.mock(/\/backend\/device\/setwifis/, 'post', devAPI.setwifis)
Mock.mock(/\/backend\/device\/transgroup/, 'post', devAPI.transgroup)
