    ...
    <div class="">
        ...
        <div class="page-center show_left_center frt">
            <div class="" style="height:38px">
                ...
                <el-dropdown :hide-on-click="false" :show-timeout="0" class="frt mr20" @command="haClick" >
                    <span class="">
        ...
        <el-drawer
            ...
            <dev-conf :types="confTypes" :devmac="confMac" ></dev-conf>
        </el-drawer>
    </div>
</template>
<script>
    ...
    data() {
        return {
            ...
            filter_column:[
                ...
                {filter:true,checked:true,"name":this.$t('device.dev_mac'),"width":"15%","type":"","align":"center","prop":"dev_mac","sortable":false,},
                {filter:true,checked:true,"name":this.$t('device.dev_ip'),"width":"14%","type":"","align":"center","prop":"dev_ip","sortable":false}, 
                {filter:true,checked:true,"name":this.$t('device.dev_name'),"width":"10%","type":"","align":"center","prop":"name_txt","sortable":'custom',"sortData":"name"},    
                {filter:true,checked:true,"name":this.$t('device.dev_type'),"width":"10%","type":"","align":"center","prop":"prt_size","sortable":'custom',"sortData":"type"},
                {filter:true,checked:true,"name":this.$t('device.dev_mode'),"width":"10%","type":"","align":"center","prop":"mode_txt","sortable":false},
                {filter:true,checked:true,"name":this.$t('device.dev_version'),"width":"15%","type":"","align":"center","prop":"ver_txt","sortable":false},
                {filter:true,checked:true,"name":this.$t('device.dev_access_time'),"width":"14%","type":"","align":"center","prop":"time_txt","sortable":'custom',"sortData":"join_time"},
    ...
    methods: {
        ...
        handleTable(data,thistotal){
            ...
            for(var i=0;i<data.length;i++){
                ...
                if(data[i].status != 0){
                    data[i].name_txt = '<div class="txt_el blue_font cur" title="'+data[i].name+'" ><i class="el-icon-edit"></i>   '+data[i].name+'</div>';
