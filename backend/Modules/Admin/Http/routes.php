...
Route::group(["prefix" => "admin/develop","middleware" => ["cloudnetlotadmin","auth:cloudnetlotadmin"],"namespace" => "Modules\Admin\Http\Controllers"],function(){
	Route::post("list","DevelopController@getList")->middleware("hash-encode:list.*.user_id");//获取开发者列表
	...
	Route::post("product/list","ProductController@getList")->middleware("hash-encode:list.*.");//获取产品列表
